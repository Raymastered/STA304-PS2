...
```{r SetupPreview}
filtered_data %>% slice(1:10) %>% select(age, education, occupation, income_respondent)
```
...
Finally, we can perform our multiple linear regression on the 3 parameters above for income together. We will not be able to plot this easily, so we will just represent it as a function based on the results of the calculations.
